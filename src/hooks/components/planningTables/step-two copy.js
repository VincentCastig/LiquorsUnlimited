...
const StepTwo = ({ handleChangeValue, drinksTotal, totalPercentage }) => {
    const [sizes, setSizes] = useState({
        drinksData: {
            // type, [label, percentage, size, drinks per liter]
            Beer: ['Beer', 20, '', 0],
            Red: ['Red Wine', 12, 0.75, 5],
            White: ['White Wine', 20, 0.75, 5],
            Rose: ['Rose Wine', 8, 0.75, 5],
            Bourbon: ['Bourbon', 8, 0.75, 17],
            Scotch: ['Scotch', 6, 0.75, 17],
            Tequila: ['Tequila', 4, 0.75, 17],
            Gin: ['Gin', 4, 0.75, 17],
